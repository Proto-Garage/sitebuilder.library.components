    ...
    render() {
        return (React.createElement(Wrapper, { className: "py-3" },
            React.createElement(reactstrap_1.Container, null,
                React.createElement(Menu_1.default, { center: true }),
                React.createElement(Description_1.default, { separator: true, theme: "dark" }),
...
exports.default = Footer4;
const Wrapper = styled_components_1.default.div `
  background-color: #e6e6e6;
`;
//# sourceMappingURL=Footer4.js.map